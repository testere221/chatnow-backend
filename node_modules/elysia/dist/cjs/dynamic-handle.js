...
var injectDefaultValues = (typeChecker, obj) => {
  ...
  let { mapResponse, mapEarlyResponse } = app["~adapter"].handler, defaultHeader = app.setHeaders;
  return async (request) => {
    ...
    try {
      ...
      let reportedError = error instanceof import_value2.TransformDecodeError && error.error ? error.error : error;
