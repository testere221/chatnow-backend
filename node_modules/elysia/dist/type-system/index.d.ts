import type { ArrayOptions, DateOptions, IntegerOptions, ObjectOptions, SchemaOptions, TAnySchema, TArray, TBoolean, TDate, TEnumValue, TInteger, TNumber, TObject, TProperties, TSchema, TString, NumberOptions, JavaScriptTypeBuilder, StringOptions, TUnsafe, Uint8ArrayOptions } from '@sinclair/typebox';
import './format';
import { CookieValidatorOptions, TFile, FilesOptions, NonEmptyArray, TForm, TUnionEnum, ElysiaTransformDecodeBuilder, TArrayBuffer } from './types';
...
export declare const ElysiaType: {
    ...
    ArrayQuery: <T extends TSchema = TString>(children?: T, options?: ArrayOptions) => TArray<T>;
    File: TFile;
    ...
    ArrayBuffer(options?: TArrayBuffer): TUnsafe<ArrayBuffer>;
    Uint8Array: (options: Uint8ArrayOptions) => TUnsafe<Uint8Array>;
};
export { t };
